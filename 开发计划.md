...
- [ ] 1.1 JwtUtil 工具类（生成 accessToken/refreshToken、解析、验证）
- [ ] 1.2 AuthController（/auth/login、/auth/getUserInfo、/auth/refreshToken）
- [ ] 1.3 JwtAuthenticationFilter（拦截请求、验证 token、注入用户上下文）
- [ ] 1.4 SecurityConfig 配置（白名单、认证规则）
- [ ] 1.5 前端对接登录，测试完整流程
- [ ] 1.6 清理临时代码（AdminPasswordInitializer）
