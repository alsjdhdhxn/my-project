...
CREATE TABLE T_COST_PINGGU (
    ...
    FMNAME VARCHAR2(100) DEFAULT '人民币', FMRATE NUMBER DEFAULT 1,
...
CREATE TABLE T_COST_PINGGU_DTL (
    ...
    BATCH_QTY NUMBER, PRICE NUMBER, COST_BATCH NUMBER, MEMO VARCHAR2(100),
    ...
    BASE_PRICE NUMBER, SUQTY NUMBER,
...
BEGIN
    ...
    INSERT INTO T_COST_COLUMN_METADATA (ID, TABLE_METADATA_ID, FIELD_NAME, COLUMN_NAME, TARGET_COLUMN, HEADER_TEXT, DATA_TYPE, DISPLAY_ORDER, CREATE_BY) VALUES (SEQ_COST_COLUMN_METADATA.NEXTVAL, v_material_id, 'id', 'ID', 'DTLID', 'ID', 'number', 0, 'system');
    ...
    INSERT INTO T_COST_COLUMN_METADATA (ID, TABLE_METADATA_ID, FIELD_NAME, COLUMN_NAME, TARGET_COLUMN, HEADER_TEXT, DATA_TYPE, DISPLAY_ORDER, CREATE_BY) VALUES (SEQ_COST_COLUMN_METADATA.NEXTVAL, v_package_id, 'id', 'ID', 'DTLID', 'ID', 'number', 0, 'system');
...
INSERT INTO T_COST_PINGGU (
    ...
    FMNAME, FMRATE, GOODSNAME_EN, LIVERY
)
SELECT 
    GOODSID, GOODSNAME, STRENGTH, MA_NO, APEX_PL, MAH, P_PERPACK, FORM, S_PERBACK, PACKTYPE,
    X_PERBACK, TOTAL_FL, TOTAL_BC, TOTAL_YL, MEMO, USESTATUS, DOCID, DOSAGE, ANNUAL_QTY, YIELD,
...
INSERT INTO T_COST_PINGGU_DTL (
    ...
    COST_BATCH, MEMO, DTLID, APEX_FACTORYNAME, APEX_FACTORYID, MODIFYDATE, BASE_PRICE,
...
SELECT 
    ...
    d.COST_BATCH, d.MEMO, d.DTLID, d.APEX_FACTORYNAME, d.APEX_FACTORYID, d.MODIFYDATE, d.BASE_PRICE,
