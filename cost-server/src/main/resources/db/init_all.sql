...
BEGIN
    ...
    INSERT INTO T_COST_COLUMN_METADATA (ID, TABLE_METADATA_ID, FIELD_NAME, COLUMN_NAME, QUERY_COLUMN, TARGET_COLUMN, HEADER_TEXT, DATA_TYPE, DISPLAY_ORDER, CREATE_BY)

    VALUES (SEQ_COST_COLUMN_METADATA.NEXTVAL, v_material_id, 'masterId', 'MASTER_ID', 'MASTER_ID', 'DOCID', '主表ID', 'number', 1, 'system');
...
BEGIN
    ...
    VALUES (SEQ_COST_COLUMN_METADATA.NEXTVAL, v_package_id, 'masterId', 'MASTER_ID', 'MASTER_ID', 'DOCID', '主表ID', 'number', 1, 'system');
...
BEGIN
    ...
    VALUES
        ...
        (v_wms_con_doc_id, 'WmsConDoc', '装箱发运单', 'T_WMS_CON_DOC_V', 'T_WMS_CON_DOC_V', 'SEQ_WMS_CON_DOC', 'CONID', 'system');
...
BEGIN
    ...
    VALUES
        ...
        (v_wms_qty_id, 'WmsQty', '装箱数量汇总', 'T_WMS_QTY_V', 'T_WMS_QTY_V', 'SEQ_WMS_QTY', 'ID', 'WmsConDoc', 'CONID', 'system');
...
BEGIN
    ...
    VALUES
        ...
        (v_wms_qty_dtl_id, 'WmsQtyDtl', '装箱数量明细', 'T_WMS_QTY_DTL_V', 'T_WMS_QTY_DTL_V', 'SEQ_WMS_QTY_DTL', 'ID', 'WmsConDoc', 'CONID', 'system');
