...
function columnDefsEquivalent(left: any[] | undefined | null, right: any[] | undefined | null): boolean {
...
function detailColumnDefsMapEquivalent(
...
function shouldUseCalcOnlyHotReload(payload?: Record<string, any>): boolean {
